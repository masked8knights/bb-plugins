...
export default {
  resolve: {
    alias: [
      {
        find: /^@bb\/plugin-sdk\/testing\/app$/,
        replacement: join(sdkRoot, "dist/testing/app.js"),
      },
      {
        find: /^@bb\/plugin-sdk\/testing$/,
        replacement: join(sdkRoot, "dist/testing/index.js"),
      },
      {
        find: /^@bb\/plugin-sdk\/app$/,
        replacement: join(sdkRoot, "dist/app.js"),
      },
      {
        find: /^@bb\/plugin-sdk$/,
        replacement: join(sdkRoot, "dist/index.js"),
      },
      ...
      },
      {
        ...
        replacement: join(packageNodeModules, "react/jsx-dev-runtime.js"),
      },
      {
        find: /^react-dom$/,
      ...
      },
      {
        ...
        replacement: join(packageNodeModules, "react-dom/client.js"),
      },
      {
