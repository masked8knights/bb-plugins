...
const ITEM_ICON_CLASS = "bb-copy-session-id-menu-icon";
...
const COPY_ICON_PATHS = [
  "M9 15C9 12.1716 9 10.7574 9.87868 9.87868C10.7574 9 12.1716 9 15 9L16 9C18.8284 9 20.2426 9 21.1213 9.87868C22 10.7574 22 12.1716 22 15V16C22 18.8284 18.8284 22 16 22H15C12.1716 22 9 18.8284 9 16L9 15Z",
...
function createCopyIcon(document: Document): SVGSVGElement {
  ...
  icon.setAttribute("class", ITEM_ICON_CLASS);
...
function updateMenuItem(item: HTMLElement, sessionId: string): void {
  ...
  item.replaceChildren(createCopyIcon(item.ownerDocument), label);
}
